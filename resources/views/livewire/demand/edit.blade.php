<div>
    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden p-6">
        <flux:fieldset>
            <flux:legend>Edit Permintaan Barang</flux:legend>
            <div class="space-y-6 ">
                <div class="grid md:grid-cols-2 gap-x-4 gap-y-6">
                    <flux:input label="Nomor Permintaan" placeholder="Nomor Permintaan" wire:model="demand_number" readonly />
                    ...
                    <flux:input label="Catatan" placeholder="Catatan" wire:model="note" />
                </div>
            </div>
        </flux:fieldset>
    </div>
    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden p-6 mt-5">
        <flux:fieldset>
            ...
            @endforeach
            <flux:button type="button" variant="filled" wire:click="update" class="cursor-pointer">Update</flux:button>
        </flux:fieldset>
    </div>
</div>
