<div x-data="{
    ...
    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden p-6">
        <flux:fieldset>
            <flux:legend>Edit Order Barang</flux:legend>
            <div class="space-y-6 ">
                <div class="grid md:grid-cols-2 gap-x-4 gap-y-6">
                    <flux:input label="Nomor Order" placeholder="Nomor Order" wire:model="order_number" />
                    ...
                    <flux:input label="note" placeholder="note" wire:model="note" />
                </div>
            </div>
        </flux:fieldset>
    </div>
