<div class="space-y-3 mb-3">
    <flux:modal name="edit-vendor" class="!w-[80vw] !max-w-[80vw] !h-[80vh] !max-h-[80vh]">
    <div class="space-y-6">
        <div>
            <flux:heading size="lg">Manajemen Vendor</flux:heading>
            <flux:text class="mt-2">Edit Vendor.</flux:text>
        </div>
